...
class TestBUZ2:
    ...
    def __init__(self):
        ...
        self.ust_1: float = 75.8
        self.ust_2: float = 20.3

        self.coef_volt: float = 0.0
        self.health_flag: bool = False

        self.msg_1: str = "Убедитесь в отсутствии блоков в панелях разъемов. " \
                          "Вставьте испытуемый блок БУЗ-2 в разъем Х17 на панели B."
        self.msg_2: str = "Вставьте заведомо исправные блок БИ в разъем Х26  и блок БДЗ в разъем Х16, " \
                          "расположенные на панели B."
        self.msg_3: str = "Установите с помощью кнопок SB1, SB2 следующие уровни уставок: ПМЗ – 2000 А; ТЗП – 400 А"
