...
class PervObmTV1:
    ...
    def perv_obm_tv1(self, calc_vol: float = 0.0):
        ...
        if calc_vol < 3.67:
            ...
            self.cli_log.log_msg(f"перв. обм. 1: на вход получили: {calc_vol:.2f}, "
            ...
            self.cli_log.log_msg(f"перв. обм. 1: на вход получили: {calc_vol:.2f}, 3.67 <= < 3.89: KL38 == True:",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 2: на вход получили: {calc_vol:.2f}, 3.89 <= < 4.11: KL39 == True:",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 3: на вход получили: {calc_vol:.2f}, 4.11 <= < 4.35: KL40 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 4: на вход получили: {calc_vol:.2f}, 4.35 <= < 4.57: KL41 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 5: на вход получили: {calc_vol:.2f}, 4.57 <= < 4.77: KL42 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 6: на вход получили: {calc_vol:.2f}, 4.77 <= < 5.03: KL43 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 7: на вход получили: {calc_vol:.2f}, 5.03 <= < 5.25: KL44 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 8: на вход получили: {calc_vol:.2f}, 5.25 <= < 5.48: KL45 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 9: на вход получили: {calc_vol:.2f}, 5.48 <= < 5.71: KL46 == True",
                                 "orange")
            ...
            self.cli_log.log_msg(f"перв. обм. 10: на вход получили: {calc_vol:.2f}, 5.71 <= < 5.97: KL47 == True",
                                 "orange")
...
class VtorObmTV1:
    ...
    def vtor_obm_tv1(self, calc_vol: float = 0.0):
        ...
        if calc_vol < 3.66:
            ...
            self.cli_log.log_msg(f"втор. обм. 1: на вход получили: {calc_vol:.2f}, "
            ...
            self.cli_log.log_msg(f"втор. обм. 2: на вход получили: {calc_vol:.2f}, 3.67 <= <= 5.96: KL59", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 3: на вход получили: {calc_vol:.2f}, 5.97 <= <= 9.64: KL58", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 4: на вход получили: {calc_vol:.2f}, 9.65 <= <= 15.15: KL57", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 5: на вход получили: {calc_vol:.2f}, 15.16 <= <= 23.87: KL56", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 6: на вход получили: {calc_vol:.2f}, 23.88 <= <= 37.65: KL55", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 7: на вход получили: {calc_vol:.2f}, 37.66 <= <= 59.7: KL54", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 8: на вход получили: {calc_vol:.2f}, 59.71 <= <= 93.69: KL53", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 9: на вход получили: {calc_vol:.2f}, 93.7 <= <= 146.5: KL52", "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 10: на вход получили: {calc_vol:.2f}, 146.51 <= <= 156.15: KL51",
                                 "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 11: на вход получили: {calc_vol:.2f}, 156.16 <= <= 163.96: KL50",
                                 "orange")
            ...
            self.cli_log.log_msg(f"втор. обм. 17: на вход получили: {calc_vol:.2f}, 182.29 <= <= 184.68: KL51",
                                 "orange")
            self.ctrl_kl.ctrl_relay('KL51', True)
        elif 184.69 <= calc_vol <= 186.0:
            self.logger.debug(f"втор. обм. 18: на вход получили: {calc_vol:.2f}, 184.69 <= <= 186.0: KL50")
            self.cli_log.log_msg(f"втор. обм. 18: на вход получили: {calc_vol:.2f}, 184.69 <= <= 186.0: KL50", "orange")
            self.ctrl_kl.ctrl_relay('KL50', True)
        elif 186.01 <= calc_vol <= 190.18:
            self.logger.debug(f"втор. обм. 19: на вход получили: {calc_vol:.2f}, 186.01 <= <= 190.18: KL48")
            self.cli_log.log_msg(f"втор. обм. 19: на вход получили: {calc_vol:.2f}, 186.01 <= <= 190.18: KL48",
                                 "orange")
