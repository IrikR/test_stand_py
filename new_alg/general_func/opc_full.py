...
class ConnectOPC:
    ...
    def __init__(self):
        ...
        self.tags_list: list[str] = ['Выходы.inputs.inp_00', 'Выходы.inputs.inp_01',
        ...
        self.dic_relay: dict[str, str] = {'KL1': 'Устройство.tg.in_perekl_rejimov_KL1',
        ...
        self.list_relay: tuple[str, ...] = ('Устройство.tg.in_perekl_rejimov_KL1', 'Устройство.tg.in_power_18V_KL2',
        ...
        self.list_relay_true: tuple[[str, bool], ...] = (('Устройство.tg.in_perekl_rejimov_KL1', True),
        ...
        self.list_relay_false: tuple[[str, bool], ...] = (('Устройство.tg.in_perekl_rejimov_KL1', False),
        ...
        self.list_perv_obm_tv1_off: tuple[[str, bool], ...] = (('Устройство.tg.in_perv_obm_TV1_KL38', False),
                                                               ('Устройство.tg.in_perv_obm_TV1_KL39', False),
                                                               ('Устройство.tg.in_perv_obm_TV1_KL40', False),
                                                               ('Устройство.tg.in_perv_obm_TV1_KL41', False),
                                                               ('Устройство.tg.in_perv_obm_TV1_KL42', False),
                                                               ...
                                                               ('Устройство.tg.in_perv_obm_TV1_KL46', False),
                                                               ('Устройство.tg.in_perv_obm_TV1_KL47', False))
        self.list_vtor_obm_tv_off: tuple[[str, bool], ...] = (('Устройство.tg.in_vtor_obm_TV1_KL48', False),
                                                              ('Устройство.tg.in_vtor_obm_TV1_KL49', False),
                                                              ('Устройство.tg.in_vtor_obm_TV1_KL50', False),
                                                              ('Устройство.tg.in_vtor_obm_TV1_KL51', False),
                                                              ('Устройство.tg.in_vtor_obm_TV1_KL52', False),
                                                              ...
                                                              ('Устройство.tg.in_vtor_obm_TV1_KL59', False),
                                                              ('Устройство.tg.in_KZ_obmotka_KL60', False))
        self.ao_teg_list: list[str] = ['Устройство.tegs.error_1', 'Устройство.tegs.error_2',
                                       'Устройство.tegs.error_3', 'Устройство.tegs.error_4']

        self.tags_value: list = []
        self.analog_tags_value: list = []
